...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('newfeng/css/common.css') }}">
    <style>
        * {
            margin: 0;
            margin: 0;
...
<body>
<div class="g-header other-header clearfix" style="background-color: #1e1e1b;">
    <div class="container">
        <div class="head-title pull-left">
            风速 VPN线下版本下载
        </div>
        <div class="logo pull-right">
            <img src="{{ asset('newfeng/images/newfeng_head_logo.png') }}" alt="">
        </div>
    </div>
</div>
<div class="wrapper">
    ...
    <ul>
        <li class="item">
            ...
            <div class="con">
                <img class="img" src="{{ asset('newfeng/images/icon_testflight.png') }}" alt="">
                <div class="between">
                    <div class="con-item">
                        <div class="des">
                            <p>下载 TestFlight</p>
        ...
        <li class="item">
            <div class="item-title">
                <h2>步骤2<span>获取风速 VPN</span></h2>
            </div>
            <div class="con">
                <img class="img" src="{{ asset('newfeng/images/newfeng_logo.png') }}" alt="">
                <div class="between">
                    <div class="con-item">
                        <div class="des">
                            <p>风速 VPN</p>
