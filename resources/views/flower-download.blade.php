...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('flower/css/common.css') }}">
    <style>
        * {
            margin: 0;
        }
...
<div class="g-header other-header clearfix">
    <div class="container">
        ...
        <div class="logo pull-right">
            <img src="{{ asset('flower/images/flower_head_logo.jpg') }}" alt="">
        </div>
    </div>
</div>
<div class="wrapper">
    ...
    <ul>
        <li class="item">
            ...
            <div class="con">
                <img class="img" src="{{ asset('flower/images/icon_testflight.png') }}" alt="">
                <div class="between">
                    <div class="con-item">
                        <div class="des">
                            <p>下载 TestFlight</p>
        ...
        <li class="item">
            <div class="item-title">
                <h2>步骤2<span>获取太阳花VPN</span></h2>
            </div>
            <div class="con">
                <img class="img" src="{{ asset('flower/images/flower_logo.png') }}" alt="">
                <div class="between">
                    <div class="con-item">
                        <div class="des">
                            <p>太阳花 VPN</p>
