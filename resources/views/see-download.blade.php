...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('seesee/css/common.css') }}">
    <style>
        * {
            margin: 0;
            margin: 0;
...
<div class="g-header other-header clearfix">
    <div class="container">
        ...
        <div class="logo pull-right">
            <img src="{{ asset('seesee/images/see_head_logo.png') }}" alt="">
        </div>
    </div>
</div>
<div class="wrapper">
    ...
    <ul>
        <li class="item">
            ...
            <div class="con">
                <img class="img" src="{{ asset('seesee/images/icon_testflight.png') }}" alt="">
                <div class="between">
                    <div class="con-item">
                        <div class="des">
                            <p>下载 TestFlight</p>
        ...
        <li class="item">
            ...
            <div class="con">
                <img class="img" src="{{ asset('seesee/images/see_logo.png') }}" alt="">
                <div class="between">
                    <div class="con-item">
                        <div class="des">
                            <p>See VPN</p>
