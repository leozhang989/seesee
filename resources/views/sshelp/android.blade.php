...
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>安卓 Android 使用 Shadowsocks 设置教程 | Shadowsocks</title>
...
<div class="container-lg px-3 my-5 markdown-body">
    ...
    <table>
        ...
        <tr>下载：</tr>
        <tr>
            <td>[推荐]<a href="https://github.com/shadowsocks/shadowsocks-android/releases/download/v4.8.1/shadowsocks-x86-4.8.1.apk">Shadowsocks-APK文件点击下载直接安装</a></td>
